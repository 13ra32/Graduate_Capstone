...
if("TRUE" STREQUAL "TRUE")
  set(state_machine_SOURCE_PREFIX /home/ralexander/catkin_ws_trr/src/Teach-Repeat-Replan/simulation/state_machine)
  set(state_machine_DEVEL_PREFIX /home/ralexander/catkin_ws_trr/devel)
  ...
  set(state_machine_INSTALL_PREFIX /home/ralexander/catkin_ws_trr/install)
...
if(NOT "/home/ralexander/catkin_ws_trr/src/Teach-Repeat-Replan/simulation/state_machine/include " STREQUAL " ")
  set(state_machine_INCLUDE_DIRS "")
  set(_include_dirs "/home/ralexander/catkin_ws_trr/src/Teach-Repeat-Replan/simulation/state_machine/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'william.wu <wwuar@connect.ust.hk>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ralexander/catkin_ws_trr/src/Teach-Repeat-Replan/simulation/state_machine/${idir}'.  ${_report}")
    endif()
