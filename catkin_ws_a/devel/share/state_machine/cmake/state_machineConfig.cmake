...
if("TRUE" STREQUAL "TRUE")
  set(state_machine_SOURCE_PREFIX /home/ralexander/catkin_ws_a/src/ground_station/simulation/state_machine)
  set(state_machine_DEVEL_PREFIX /home/ralexander/catkin_ws_a/devel)
  ...
  set(state_machine_INSTALL_PREFIX /home/ralexander/catkin_ws_a/install)
...
if(NOT "/home/ralexander/catkin_ws_a/src/ground_station/simulation/state_machine/include " STREQUAL " ")
  set(state_machine_INCLUDE_DIRS "")
  set(_include_dirs "/home/ralexander/catkin_ws_a/src/ground_station/simulation/state_machine/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ralexander/catkin_ws_a/src/ground_station/simulation/state_machine/${idir}'.  ${_report}")
    endif()
